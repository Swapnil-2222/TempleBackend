...
export const sampleWithPartialData: IDelegate = {
  ...
  status: 'after',
  lastModified: dayjs('2023-10-18T06:02'),
  ...
  freeField5: 6617,
  freeField6: 30581,
  freeField8: dayjs('2023-10-17T22:44'),
  freeField10: true,
...
export const sampleWithFullData: IDelegate = {
  ...
  departureDate: dayjs('2023-10-17T19:56'),
  departurePlace: 'yahoo',
  arrivalDate: dayjs('2023-10-18T15:42'),
  arrivalPlace: 'fuzzy',
  status: 'preserve colorfully brightly',
  lastModified: dayjs('2023-10-18T05:54'),
  ...
  freeField5: 7454,
  freeField6: 26593,
  freeField7: dayjs('2023-10-18T13:32'),
  freeField8: dayjs('2023-10-18T12:36'),
  freeField9: false,
  freeField10: false,
